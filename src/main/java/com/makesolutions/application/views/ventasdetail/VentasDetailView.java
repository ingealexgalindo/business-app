...
@PageTitle("Ventas Detail")
@Route(value = "Ventas-Detail", layout = MainLayout.class)
@RolesAllowed("USER")
@Uses(Icon.class)
public class VentasDetailView extends Div {
    ...
    public VentasDetailView(SamplePersonService SamplePersonService) {
        this.samplePersonService = SamplePersonService;
        setSizeFull();
        addClassNames("ventas-detail-view");
