...
@PageTitle("Clientes")
@Route(value = "Clientes-detail/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@RolesAllowed("USER")
@Uses(Icon.class)
public class ClientesView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "Clientes-detail/%s/edit";
    ...
    public ClientesView(SamplePersonService samplePersonService) {
